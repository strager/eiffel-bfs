...
void egc_init_plug (void)
{
	...
	egc_arrmake = (void (*)(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) F248_3187;
	...
	egc_sp_bool = 0x02DF;
	egc_sp_uint8 = 0x0199;
	egc_sp_uint16 = 0x0150;
	egc_sp_uint32 = 0x0231;
	egc_sp_uint64 = 0x0323;
	egc_sp_int8 = 0x0386;
	egc_sp_int16 = 0x0280;
	egc_sp_int32 = 0x02A4;
	egc_sp_int64 = 0x02BA;
	egc_sp_real32 = 0x0175;
	egc_sp_real64 = 0x025C;
	egc_sp_pointer = 0x0200;
	egc_sp_ref = 0x0110;
	...
	egc_system_name = "bfs";
	egc_system_location = "/home/strager/tmp/bfs/EIFGENs/bfs/W_code";
	egc_compiler_tag = 38;
	egc_project_version = 1579144187;
