...
static const EIF_TYPE_INDEX egt_17_982 [] = {0xFF01,870,0xFF01,0xFFF9,0,186,0xFFFF};
...
static const struct desc_info desc_982[] = {
	...
	{EIF_GENERIC(egt_14_982), 13719, 0},
	{EIF_GENERIC(egt_15_982), 13720, 8},
	{EIF_GENERIC(egt_16_982), 13721, 16},
	{EIF_NON_GENERIC(0x01B5 /*218*/), 13722, 36},
	{EIF_GENERIC(egt_17_982), 13732, 24},
};
void Init982(void)
{
	IDSC(desc_982, 0, 981);
