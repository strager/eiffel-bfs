...
static const struct desc_info desc_981[] = {
	...
	{EIF_NON_GENERIC(0x0197 /*203*/), 13717, 40},
	{EIF_NON_GENERIC(0x0197 /*203*/), 13718, 41},
	{EIF_GENERIC(egt_14_981), 13719, 0},
	{EIF_GENERIC(egt_15_981), 13720, 8},
	{EIF_GENERIC(egt_16_981), 13721, 16},
	{EIF_NON_GENERIC(0x01B5 /*218*/), 13722, 44},
	{EIF_GENERIC(egt_17_981), 13723, 24},
	{EIF_GENERIC(NULL), 13725, 0xFFFFFFFF},
	{EIF_GENERIC(egt_18_981), 13728, 32},
};
void Init981(void)
{
	IDSC(desc_981, 0, 980);
	...
	IDSC(desc_981 + 91, 366, 980);
	IDSC(desc_981 + 103, 368, 980);
}
