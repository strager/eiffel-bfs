...
{
	GTCX
	RTOTC (F963_7245,13539,RTMS_EX_H("English",7,257590376));
}
...
#define Result RTOTRR
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {272,0xFF01,232,0xFFFF};
		EIF_TYPE typres0;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 962, Current, 0, 0, 13541);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
{
	GTCX
	RTOTC (F963_7250,13544,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F963_7251,13545,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
{
	GTCX
	RTOTC (F963_7252,13546,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit963 (void)
{
	GTCX
	RTOTS (7245,F963_7245)
	RTOTS (7246,F963_7246)
	RTOTS (7247,F963_7247)
	RTOTS (7248,F963_7248)
	RTOTS (7249,F963_7249)
	RTOTS (7250,F963_7250)
