...
static const EIF_TYPE_INDEX egt_17_980 [] = {0xFF01,266,0xFF01,0xFFF9,0,186,0xFFFF};
...
static const struct desc_info desc_980[] = {
	...
	{EIF_GENERIC(egt_13_980), 1317, 0xFFFFFFFF},
	...
	{EIF_NON_GENERIC(0x0197 /*203*/), 13717, 32},
	{EIF_NON_GENERIC(0x0197 /*203*/), 13718, 33},
	{EIF_GENERIC(egt_14_980), 13719, 0},
	{EIF_GENERIC(egt_15_980), 13720, 8},
	{EIF_GENERIC(egt_16_980), 13721, 16},
	{EIF_NON_GENERIC(0x01B5 /*218*/), 13722, 36},
	{EIF_GENERIC(egt_17_980), 13723, 24},
};
void Init980(void)
{
	IDSC(desc_980, 0, 979);
	IDSC(desc_980 + 1, 1, 979);
	IDSC(desc_980 + 32, 193, 979);
	IDSC(desc_980 + 65, 234, 979);
	IDSC(desc_980 + 66, 102, 979);
	IDSC(desc_980 + 91, 366, 979);
}
